 ...
 */
#define JSON_TOKENER_STRICT (unsigned)0x01
 ...
 * @see json_tokener_set_flags()
 */
#define JSON_TOKENER_ALLOW_TRAILING_CHARS (unsigned)0x02
 ...
 * @see json_tokener_set_flags()
 */
#define JSON_TOKENER_VALIDATE_UTF8 (unsigned)0x10
 ...
 */
JSON_EXPORT json_tokener* json_tokener_new_ex(const int depth);

/**
 * Free a json_tokener previously allocated with json_tokener_new().
 */
JSON_EXPORT void json_tokener_free(json_tokener *tok);

/**
 * Reset the state of a json_tokener, to prepare to parse a 
 * brand new JSON object.
 */
JSON_EXPORT void json_tokener_reset(json_tokener *tok);
 ...
 */
JSON_EXPORT json_object* json_tokener_parse(const char* str);
 ...
 * @see json_tokener_parse_ex()
 */
JSON_EXPORT json_object* json_tokener_parse_verbose(const char* str, enum json_tokener_error *error);
 ...
 */
JSON_EXPORT json_object* json_tokener_parse_ex(json_tokener *, const char*, const int);
