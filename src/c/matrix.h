...
/* Operators */
void matrix_equal(register Matrix *, const Matrix *const);
...
const json_object* matrix_serialize(const Matrix *const);
...
Matrix* matrix_map_static(const Matrix *const, float (*)(float));
